...
#define FFMPEG_CONFIGURATION "--extra-cflags=-mno-cygwin -mms-bitfields --extra-ldflags=-Wl,-add-stdcall-alias --enable-memalign-hack --target-os=mingw32 --enable-gpl"
...
#define ENABLE_ADPCM_EA_MAXIS_XA_DECODER 0
