...
REM ffmpeg -i img\%%03d.jpg -an -r 24 -s 768×576 flv\output.flv
ffmpeg -i img\%%03d.jpg -an -r 24 -s 768×576 F:\Development\CPP\RTMP\utils\FFmpeg-svn-14277\FFmpeg-svn-14277\test\output.flv
